...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$root'; & '.\.venv\Scripts\Activate.ps1'; python -m uvicorn app.main:app --app-dir backend --host 127.0.0.1 --port 8000 --reload"
